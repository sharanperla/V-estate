  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
        <form onSubmit={handleSubmit} action="" className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <select onChange={handleChange} defaultValue={'created_at_desc'} name="" id="order" className="border rounded-lg p-3">
      ...
      <div className="p-7 flex flex-wrap gap-4">
        ...
        (
          <p  className="text-xl text-slate-700 ">No listigs found!</p>
        )}
        {
          loading && (
